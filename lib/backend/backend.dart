...
import 'schema/iot_data_record.dart';
...
export 'schema/iot_data_record.dart';
...
/// Functions to query IotDataRecords (as a Stream and as a Future).
Future<int> queryIotDataRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      IotDataRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<IotDataRecord>> queryIotDataRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      IotDataRecord.collection,
      IotDataRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<IotDataRecord>> queryIotDataRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
